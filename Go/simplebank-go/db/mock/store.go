...
// Source: github.com/ethantiger/simplebank/db/sqlc (interfaces: Store)
//
// Generated by this command:
//
//	mockgen -package mockdb -destination db/mock/store.go github.com/ethantiger/simplebank/db/sqlc Store
//
